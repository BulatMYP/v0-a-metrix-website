  ...
  return (
    <section id="contacts" className="py-20 md:py-28">
      <div className="mx-auto max-w-7xl px-4 md:px-6">
        ...
        {/* Map Section */}
        <div className="mt-16">
          <h3 className="text-2xl font-semibold mb-8 text-card-foreground text-center">
            Где нас найти
          </h3>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="rounded-lg overflow-hidden border border-border">
              <div className="h-80 bg-gray-200 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-gray-600 font-medium">Москва</p>
                  <p className="text-sm text-gray-500">Интерактивная карта</p>
                </div>
              </div>
              <div className="p-6 bg-background border-t border-border">
                <h4 className="font-semibold text-foreground mb-2">Офис в Москве</h4>
            ...
            <div className="rounded-lg overflow-hidden border border-border">
              <div className="h-80 bg-gray-200 flex items-center justify-center">
                <div className="text-center">
                  <MapPin className="h-12 w-12 text-gray-400 mx-auto mb-4" />
                  <p className="text-gray-600 font-medium">Казань</p>
                  <p className="text-sm text-gray-500">Интерактивная карта</p>
                </div>
              </div>
              <div className="p-6 bg-background border-t border-border">
                <h4 className="font-semibold text-foreground mb-2">Офис в Казани</h4>
                <p className="text-sm text-muted-foreground mb-4 leading-relaxed">
