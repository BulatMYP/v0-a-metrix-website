...
export const metadata: Metadata = {
  ...
  description: "Свяжитесь с tech акселератором Флагман/Tech для бесплатной консультации. Помощь в упаковке стартапа, курсы, mentorship. Офисы в Москве и Казани. hello@flgmn.tech",
  keywords: [
    'контакты флагман',
    'консультация по стартапам',
    'бесплатная консультация стартап',
    'услуги по упаковке проекта',
    'помощь в инвестиционной упаковке',
    'записаться на курс',
    'напишите нам',
...
const offices = [
  {
    city: "Москва",
    address: "улица Бакунинская 71, строение 10, офис 106",
  },
  {
    city: "Казань",
    address: "улица Декабристов, 2, здание 2, офис ",
  },
]
