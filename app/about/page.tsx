...
export const metadata: Metadata = {
  ...
  description: "Флагман/Tech — экосистема для tech предпринимателей с 2017 года. 500+ выпускников, 50+ успешных инвестиционных раундов. Курсы, консалтинг, mentorship и поддержка AI-стартапов.",
  keywords: [
    'о компании флагман tech',
    'tech акселератор москва',
    'школа предпринимателей',
    'образование для стартапов',
    'бизнес-школа',
    'экспертиза в стартапах',
    'mentorship программа',
    'поддержка предпринимателей',
    'APEX Metrical',
    'история успеха стартапов'
  ]
}
  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
          ...
          <div className="mx-auto max-w-6xl px-4 md:px-6">
            <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
              ...
              <div className="rounded-xl border bg-background p-8">
                <h3 className="text-xl font-semibold">Наше конкурентное преимущество</h3>
        ...
        {/* CTA */}
        <section className="border-t py-20 md:py-28 bg-popover-foreground">
          <div className="mx-auto max-w-6xl px-4 md:px-6">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mt-4 text-lg text-background/70">
                Выберите курс или запишитесь на бесплатную консультацию по упаковке проекта
              </p>
